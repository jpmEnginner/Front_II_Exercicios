...
function TodoItem({ tarefa }) {
  ...
  const { removerTarefa, adicionarPasso, togglePasso, removerPasso } = useTarefas();

  const todosConcluidos = tarefa.passos.length > 0 && tarefa.passos.every(passo => passo.concluido);
